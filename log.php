...
<div class="login-box">
  	<div class="login-logo">
		<center>
	  </h1><img src="img/logo.png" alt="" style="height: 100px; width: 100px;"></h1></center>
  		<b>Voting System</b>
  	</div>
  
  	<div class="login-box-body" style="border-radius: 1em;">
   ...
   name="voter" placeholder="Voter's ID" required>
          ...
          <div class="form-group has-feedback">
            <input type="password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  name="password" placeholder="Password" required>
            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
          </div>
      		<div class="row">
    			<div class="col-xs-4">
          			<button type="submit" class="btn btn-info bg-blue btn-block btn-round"  style="border-radius: 0.5em;"name="login"><i class="fa fa-sign-in"></i> Sign In</button>
        		</div>
      		</div>
    	</form>
  	</div>
